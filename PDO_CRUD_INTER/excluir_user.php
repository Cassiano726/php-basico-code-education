...
echo     '<html>'
        . '<body>'
        . '<form method=post action=index.php?page=controller_excluir_user>'
        . '<table>'
        . '<tr>'
        . '<label>N° Usuário::<input type=number name=id_excluir ></label>'
        . '<label>Nome Usuário::<input type=text name=nome_excluir ></label>'
        . '<label><input type=submit name=excluir_user value=Excluir>'

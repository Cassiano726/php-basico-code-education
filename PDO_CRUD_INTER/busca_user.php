...
echo '<table>'
     . '<form method=post action=index.php?page=controller_BU>'
     . '<tr>'
     . '<td>Digite o Nome:</td>'
     . '<td><label>:<input type=text name=buscar_usuario autofocus=""></label></td>'
     . '<td alingn=middle width=200> <input type=submit name=buscar_user value=Buscar ></td>'
